...
#pragma pack(push,1)
	...
	enum ParaXModelFormat {
		...
		PARAX_FORMAT_UV2 = 4,
		// this model has extended model header
		PARAX_FORMAT_EXTENDED_HEADER2 = 8,
	...
	*/
	...
	/**
	* ParaX header definition2:
	* this is extended definition, only used when (nModelFormat&PARAX_FORMAT_EXTENDED_HEADER2) is true
	*/
	struct ParaXHeaderDef2 {
		DWORD IsAnimated;
		Vector3 neck_yaw_axis;
		Vector3 neck_pitch_axis;
		Vector3 reserved0, reserved1, reserved2, reserved3, reserved4, reserved5;
		DWORD   nReserved0, nReserved1, nReserved2, nReserved3, nReserved4, nReserved5;
	};
