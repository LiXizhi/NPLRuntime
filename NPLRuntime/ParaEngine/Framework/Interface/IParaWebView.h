...
namespace ParaEngine {
	...
	public:
        ...
        ATTRIBUTE_METHOD1(IParaWebView, move_s, float) { cls->move(int x, int y); return S_OK; }
        ATTRIBUTE_METHOD1(IParaWebView, resize_s, float) { cls->resize(int width, int height); return S_OK; }
