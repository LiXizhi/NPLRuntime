...
{				
	...
	protected:
		/** 将一个点绕轴旋转
		*/
		const Vector3 vec3Rotate(const Vector3 &pt, const Vector3 &angles);
		/**将一个点绕点旋转
		*/
		const Vector3 vec3RotateByPoint(const Vector3 &originPt, const Vector3 &pt, const Vector3 &angles);
	};
