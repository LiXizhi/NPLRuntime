...
// config
bool GLImage::supportsS3TC = false;
bool GLImage::PNG_PREMULTIPLIED_ALPHA_ENABLED = true;
int  GLImage::MaxTextureSize = 1024 * 8;
...
bool GLImage::initWithRawData(const unsigned char * data, size_t dataLen, int width, int height, int bitsPerComponent, bool preMulti)
{
	bool ret = false;
	do
	{
		...
		_renderFormat = GLTexture2D::PixelFormat::RGBA8888;
...
bool GLImage::initWithImageData(const unsigned char * data, size_t dataLen)
{
...
bool GLImage::isEtc(const unsigned char * data, size_t dataLen)
{
	return false;
}


bool GLImage::isS3TC(const unsigned char * data, size_t dataLen)
{
...
bool GLImage::isATITC(const unsigned char *data, size_t dataLen)
{
	return false;
}
...
bool GLImage::isTiff(const unsigned char * data, size_t dataLen)
{
	if (dataLen <= 4)
	{
		return false;
...
bool GLImage::isWebp(const unsigned char * data, size_t dataLen)
{
	if (dataLen <= 12)
	{
		return false;
...
bool GLImage::isPvr(const unsigned char * data, size_t dataLen)
{
	return false;
}
...
bool GLImage::initWithJpgData(const unsigned char * data, size_t dataLen)
{
	...
	*/
	...
	do
	{
		...
		{
			_renderFormat = GLTexture2D::PixelFormat::I8;
		}
		else
		{
			cinfo.out_color_space = JCS_RGB;
			_renderFormat = GLTexture2D::PixelFormat::RGB888;
		}
...
#define PNGSIGSIZE  8
	...
	do
	{
		...
		case PNG_COLOR_TYPE_GRAY_ALPHA:
			_renderFormat = GLTexture2D::PixelFormat::AI88;
			break;
...
bool GLImage::initWithS3TCData(const unsigned char * data, size_t dataLen)
{
...
bool GLImage::saveToFile(const std::string &filename, bool isToRGB)
...
void GLImage::premultipliedAlpha()
{
	...
	PE_ASSERT(_renderFormat == GLTexture2D::PixelFormat::RGBA8888);
