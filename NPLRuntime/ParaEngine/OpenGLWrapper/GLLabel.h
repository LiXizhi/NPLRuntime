...
namespace ParaEngine
{
	...
	class GLLabel : public CRefCountedOne
	{
	public:
		...
		GLLabel(GLFontAtlas *atlas = nullptr, TextHAlignment hAlignment = TextHAlignment::LEFT,
		...
		GLFontAtlas* getFontAtlas() { return _fontAtlas; }
	...
	protected:
		...
		void reset();
		void setFontAtlas(GLFontAtlas* atlas, bool distanceFieldEnabled = false, bool useA8Shader = false);
	...
	{
	public:
		static bool createStringSprites(GLLabel* label);
		static bool multilineText(GLLabel* label);
		static bool alignText(GLLabel* label);
	};
}
