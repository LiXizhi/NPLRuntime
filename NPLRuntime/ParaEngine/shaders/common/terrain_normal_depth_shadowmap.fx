...
sampler BaseTexSampler : TEXTURE0 = sampler_state 
{
    texture = <BaseTex0>;
    MinFilter = Linear;  
    MagFilter = Linear;
...
sampler AlphaTex7Sampler : TEXTURE7= sampler_state 
{
	texture = <AlphaTex7>;
	MinFilter = Linear;  
	MagFilter = Linear;
	...
	sampler DetailTex8Sampler : TEXTURE8= sampler_state 
	{
		texture = <DetailTex8>;
		MinFilter = Linear;  
		MagFilter = Linear;
	...
	sampler AlphaTex9Sampler : TEXTURE9= sampler_state 
	{
		texture = <AlphaTex9>;
		MinFilter = Linear;  
		MagFilter = Linear;
	...
	sampler DetailTex10Sampler : TEXTURE10= sampler_state 
	{
		texture = <DetailTex10>;
		MinFilter = Linear;  
		MagFilter = Linear;
