...
void ParaMiniSceneGraph::SaveToFileEx(const char* sFileName, int width /*= 0*/, int height /*= 0*/, EPixelFormat dwFormat /*= 3*/, UINT MipLevels /*= 0*/, int srcLeft /*= 0*/, int srcTop /*= 0*/, int srcWidth /*= 0*/, int srcHeight /*= 0*/)
{
	if (IsValid())
	{
