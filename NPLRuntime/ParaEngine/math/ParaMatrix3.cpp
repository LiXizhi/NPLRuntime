...
namespace ParaEngine
{
	...
	Matrix3::Matrix3(const Matrix4& rkMatrix)
	{
		rkMatrix.extract3x3Matrix(*this);
	}

	void Matrix3::RotX(float angle)
	{
		*this = Matrix3::IDENTITY;
		float Cos = cosf(angle), Sin = sinf(angle); m[1][1] = m[2][2] = Cos; m[2][1] = -Sin;	m[1][2] = Sin;
	}

	void Matrix3::RotY(float angle)
	{
		*this = Matrix3::IDENTITY;
		float Cos = cosf(angle), Sin = sinf(angle);  m[0][0] = m[2][2] = Cos; m[2][0] = Sin;	m[0][2] = -Sin;
	}

	void Matrix3::RotZ(float angle)
	{
		*this = Matrix3::IDENTITY;
		float Cos = cosf(angle), Sin = sinf(angle);  m[0][0] = m[1][1] = Cos; m[1][0] = -Sin;	m[0][1] = Sin;
	}
