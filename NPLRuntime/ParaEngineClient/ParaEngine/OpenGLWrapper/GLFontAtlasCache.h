...
namespace ParaEngine
{
	...
	{
	public:
		static GLFontAtlas * getFontAtlasTTF(const TTFConfig & config);

		static bool releaseFontAtlas(GLFontAtlas *atlas);
	...
	private:
		...
		static std::unordered_map<std::string, GLFontAtlas *> _atlasMap;
	};
}