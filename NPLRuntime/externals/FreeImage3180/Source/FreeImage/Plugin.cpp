...
#ifdef FREEIMAGE_USE_OPENGEXR
			s_plugins->AddNode(InitEXR);
#endif

#ifdef FREEIMAGE_USE_OPENJPEG
...
#ifdef FREEIMAGE_USE_RAW
			s_plugins->AddNode(InitRAW);
#endif 

#ifdef FREEIMAGE_USE_WEBP
			s_plugins->AddNode(InitWEBP);
#endif

#ifdef FREEIMAGE_USE_JXR
