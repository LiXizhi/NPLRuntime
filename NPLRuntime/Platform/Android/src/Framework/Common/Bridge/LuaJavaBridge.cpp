...
namespace ParaEngine {
	...
	bool LuaJavaBridge::callIntMethod(JniMethodInfo& t, FunctionInfo& info, JObject& jobj, const luabind::object& argvs, int& ret)
	{
		auto count = info.argvs.size();
	...
	bool LuaJavaBridge::callFloatMethod(JniMethodInfo& t, FunctionInfo& info, JObject& jobj, const luabind::object& argvs, float& ret)
	{
		auto count = info.argvs.size();
	...
	bool LuaJavaBridge::callBooleanMethod(JniMethodInfo& t, FunctionInfo& info, JObject& jobj, const luabind::object& argvs, bool& ret)
	{
		auto count = info.argvs.size();
	...
	bool LuaJavaBridge::callStringMethod(JniMethodInfo& t, FunctionInfo& info, JObject& jobj, const luabind::object& argvs, std::string& ret)
	{
		auto count = info.argvs.size();
	...
	bool LuaJavaBridge::callObjectMethod(JniMethodInfo& t, FunctionInfo& info, JObject& jobj, const luabind::object& argvs, JObject& ret)
	{
		auto count = info.argvs.size();
	...
	bool LuaJavaBridge::callStaticFloatMethod(JniMethodInfo& t, FunctionInfo& info, const luabind::object& argvs, float& ret)
	{
		auto count = info.argvs.size();
	...
	bool LuaJavaBridge::callStaticObjectMethod(JniMethodInfo& t, FunctionInfo& info, const luabind::object& argvs, JObject& ret)
	{
		auto count = info.argvs.size();
	...
	bool LuaJavaBridge::callStaticStringMethod(JniMethodInfo& t, FunctionInfo& info, const luabind::object& argvs, std::string& ret)
	{
		auto count = info.argvs.size();
	...
	bool LuaJavaBridge::callStaticBooleanMethod(JniMethodInfo& t, FunctionInfo& info, const luabind::object& argvs, bool& ret)
	{
		auto count = info.argvs.size();
	...
	bool LuaJavaBridge::callStaticIntMethod(JniMethodInfo& t, FunctionInfo& info, const luabind::object& argvs, int& ret)
	{
		auto count = info.argvs.size();
	...
	bool LuaJavaBridge::callStaticVoidMethod(JniMethodInfo& t, FunctionInfo& info, const luabind::object& argvs)
	{
