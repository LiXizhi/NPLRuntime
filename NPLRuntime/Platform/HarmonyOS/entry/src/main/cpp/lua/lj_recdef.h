...
0x2100+(1),
0x2300,
0x2400+(IRCALL_lj_buf_putstr_reverse),
0x2400+(IRCALL_lj_buf_putstr_lower),
0x2400+(IRCALL_lj_buf_putstr_upper),
0,
0x2500,
0,
0,
...
0,
0x3400,
0x3500+(FF_ffi_sizeof),
0x3500+(FF_ffi_alignof),
0x3500+(FF_ffi_offsetof),
0x3600,
0x3700,
0x3800,
0x3900,
