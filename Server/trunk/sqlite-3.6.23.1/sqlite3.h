...
//NOTE LXZ:  add #include "paraengine_sqlite3.h" at the very beginning of sqlite3.h and sqlite3.c to automatically define SQLITE_API according to ParaEngine usage macro. 
#include "paraengine_sqlite3.h"
