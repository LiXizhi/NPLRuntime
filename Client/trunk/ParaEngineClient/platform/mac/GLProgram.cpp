...
{
	return this->logForOpenGLObject(_vertShader, glGetShaderiv, glGetShaderInfoLog);
}

std::string GLProgram::getFragmentShaderLog() const
{
	return this->logForOpenGLObject(_fragShader, glGetShaderiv, glGetShaderInfoLog);
}

std::string GLProgram::getProgramLog() const
{
	return this->logForOpenGLObject(_program, glGetProgramiv, glGetProgramInfoLog);
}
