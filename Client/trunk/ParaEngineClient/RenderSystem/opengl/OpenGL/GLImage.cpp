...
bool Image::isEtc(const unsigned char * data, size_t dataLen)
{
	return false;
}


bool Image::isS3TC(const unsigned char * data, size_t dataLen)
{
...
bool Image::isATITC(const unsigned char *data, size_t dataLen)
{
	return false;
}
...
bool Image::isTiff(const unsigned char * data, size_t dataLen)
{
	if (dataLen <= 4)
	{
		return false;
...
bool Image::isWebp(const unsigned char * data, size_t dataLen)
{
	if (dataLen <= 12)
	{
		return false;
...
bool Image::isPvr(const unsigned char * data, size_t dataLen)
{
	return false;
}
...
bool Image::initWithS3TCData(const unsigned char * data, size_t dataLen)
{
