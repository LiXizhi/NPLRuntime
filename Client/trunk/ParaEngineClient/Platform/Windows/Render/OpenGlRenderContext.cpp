...
ParaEngine::RenderContextOpenGL* ParaEngine::RenderContextOpenGL::Create()
{
	...
	return new RenderContextOpenGL();
}

ParaEngine::RenderContextOpenGL::~RenderContextOpenGL()
{

}

ParaEngine::IRenderDevice* ParaEngine::RenderContextOpenGL::CreateDevice(const RenderConfiguration& cfg)
{
...
bool ParaEngine::RenderContextOpenGL::ResetDevice(IRenderDevice* device, const RenderConfiguration& cfg)
{
