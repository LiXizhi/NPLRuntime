...
void CEventBinding::StaticInit()
{
	...
	ScancodeToKeyTable[(int)EVirtualKey::KEY_EQUAL]=EM_KEY_EQUALS;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_BACKSPACE]=EM_KEY_BACKSPACE;
	...
	ScancodeToKeyTable[(int)EVirtualKey::KEY_LEFT_BRACKET]=EM_KEY_LBRACKET;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_RIGHT_BRACKET]=EM_KEY_RBRACKET;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_RIGHT_SHIFT]=EM_KEY_RSHIFT;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_LEFT_SHIFT]=EM_KEY_LSHIFT;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_LEFT_CONTROL]=EM_KEY_LCONTROL;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_RIGHT_CONTROL]=EM_KEY_RCONTROL;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_RIGHT_ALT]=EM_KEY_RALT;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_LEFT_ALT]=EM_KEY_LALT;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_ENTER]=EM_KEY_RETURN;
	...
	ScancodeToKeyTable[(int)EVirtualKey::KEY_GRAVE_ACCENT]=EM_KEY_GRAVE;
	...
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_MULTIPLY]=EM_KEY_MULTIPLY;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_SPACE]=EM_KEY_SPACE;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_CAPS_LOCK]=EM_KEY_CAPSLOCK;
	...
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUM_LOCK]=EM_KEY_NUMLOCK;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_SCROLL_LOCK]=EM_KEY_SCROLLLOCK;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_0]=EM_KEY_NUMPAD0;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_1]=EM_KEY_NUMPAD1;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_2]=EM_KEY_NUMPAD2;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_3]=EM_KEY_NUMPAD3;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_4]=EM_KEY_NUMPAD4;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_5]=EM_KEY_NUMPAD5;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_6]=EM_KEY_NUMPAD6;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_7]=EM_KEY_NUMPAD7;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_8]=EM_KEY_NUMPAD8;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_9]=EM_KEY_NUMPAD9;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_ENTER]=EM_KEY_NUMPADENTER;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_EQUAL]=EM_KEY_NUMPADEQUALS;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_SUBTRACT]=EM_KEY_SUBTRACT;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_ADD]=EM_KEY_ADD;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_DECIMAL]=EM_KEY_DECIMAL;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_PAUSE]=EM_KEY_PAUSE;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_NUMPAD_DIVIDE]=EM_KEY_DIVIDE;
	...
	ScancodeToKeyTable[(int)EVirtualKey::KEY_PAGE_UP]=EM_KEY_PAGE_UP;
	ScancodeToKeyTable[(int)EVirtualKey::KEY_PAGE_DOWN]=EM_KEY_PAGE_DOWN;
