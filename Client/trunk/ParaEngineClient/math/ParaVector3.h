    ...
    */
    ...
    public:
...
#else	
		inline explicit Vector3(const DeviceVector3& v)
		: x(v.x), y(v.y), z(v.z)
		{
		}
#endif

		inline Vector3& operator = (const DeviceVector3& rkVector)
		{
			x = rkVector.x;
			y = rkVector.y;
			z = rkVector.z;
        ...
        */
		...
		inline Vector3 InvertYCopy() const
		{
			return Vector3(x, -y, z);
		}

		inline Vector3& InvertY()
		{
			y = -y;
			return *this;
		}
        ...
        */
		...
		/** only use this function. when matrix contains non-linear projection. 
		*	Result is (x/w, y/w, z/w)
		*/
        ...
        */
		...
		DeviceVector3_ptr GetPointer(){ return (DeviceVector3_ptr)this; }
    };
