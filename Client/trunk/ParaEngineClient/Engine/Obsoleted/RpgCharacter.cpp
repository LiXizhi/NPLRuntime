...
#ifndef DONOT_INCLUDE_FIELD_TYPEINFO
	assert(pClass!=NULL);
	pClass->AddField("ClassID",FieldType_Int, NULL, IAttributeFields::GetAttributeClassID_s, NULL, NULL, bOverride);
	pClass->AddField("ClassName",FieldType_String, NULL, IAttributeFields::GetAttributeClassName_s, NULL, NULL, bOverride);
#endif
