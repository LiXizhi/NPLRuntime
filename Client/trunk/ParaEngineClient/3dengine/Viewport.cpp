...
bool ParaEngine::CViewport::DrawQuad()
{
	...
	bSucceed = SUCCEEDED(CGlobals::GetRenderDevice()->DrawPrimitiveUP(RenderDeviceBase::DRAW_PERF_TRIANGLES_UNKNOWN, D3DPT_TRIANGLESTRIP, 2, quadVertices, sizeof(mesh_vertex_plain)));
#endif
