...
public:
	...
	/** which group this physics mesh belongs to.Collision detection with different group are different. 
...
private:
	...
	/// Pointer to the static physics actor in Novodex engine
...
public:
	...
	*/
	...
	int GetStaticActorCount(){return (int)m_staticActors.size();};
